        ...
        <v-table density="compact" hover>
            ...
            <tbody>
                <tr class="bg-grey-lighten-4">
                    <td v-for="col in columns" :key="'new'+col.key" :class="'text-'+col.align">
                        ...
                        <div v-else-if="col.key === 'vendor'"><v-text-field v-model="newTemplate.vendor" density="compact" hide-details placeholder="Vendor" variant="plain"></v-text-field></div>
                        <div v-else-if="col.key === 'expected_date'"><v-text-field v-model="newTemplate.expected_date" density="compact" hide-details placeholder="Day" type="number" variant="plain"></v-text-field></div>
                ...
                <tr v-for="t in filteredTemplates" :key="t.id">
                    <td v-for="col in columns" :key="col.key" :class="'text-'+col.align">
                        ...
                        <div v-else-if="col.key === 'vendor'"><v-text-field v-if="editingId===t.id" v-model="editForm.vendor" density="compact" variant="outlined" hide-details></v-text-field><span v-else>{{t.vendor}}</span></div>
                        <div v-else-if="col.key === 'expected_date'"><v-text-field v-if="editingId===t.id" v-model="editForm.expected_date" density="compact" variant="outlined" hide-details type="number"></v-text-field><span v-else>{{t.expected_date}}</span></div>
