<script setup>
    ...
    const props = defineProps({ 
        ...
        family: Array, // NEW: Meal planning people
        categories: Array, 
    ...
    const deleteTemplate = async (id) => { if(confirm("Delete?")) { await axios.delete(`${API_URL}/templates/${id}`); emit('refresh'); } };
        ...
        <v-row>
            <v-col cols="12" md="4">
                ...
                <v-card class="pa-4">
                    ...
                    <v-combobox v-model="props.people" chips multiple label="Budget Accounts (Who Pay)" @update:modelValue="saveSetting('people', props.people)"></v-combobox>
                    <v-combobox v-model="props.family" chips multiple label="Family Members (Who Eat)" @update:modelValue="saveSetting('family_members', props.family)" class="mt-2"></v-combobox>
